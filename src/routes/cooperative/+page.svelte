<script lang="ts">
  ...
  <main class="w-full">
    ...
    <a
      href="/cooperative/cm_payout"
      class="bg-buttonp rounded-lg z-4 mb-1 border-2 border-outline p-4 flex items-center hover:bg-buttonphover active:bg-buttonpactive"
    >
      <span class="text-3xl material-symbols-outlined mr-5"> contract </span>
      <div class="flex w-full flex-col h-full">
        <span>Membership Payout</span>
        <span class="text-subtext z-4">Track the payout transactions of all members.</span>
      </div>
      <span class="relative z-4 right-100 bottom-0 material-symbols-outlined">
        navigate_next
      </span>
    ...
    <a
      href="/cooperative/savings_accounts"
      class="bg-buttonp rounded-lg z-4 border-2 mb-1 border-outline p-4 flex items-center hover:bg-buttonphover active:bg-buttonpactive"
    >
      <span class="text-3xl material-symbols-outlined mr-5"> warehouse </span>
      <div class="flex w-full flex-col h-full">
        <span>Savings Accounts</span>
        <span class="text-subtext z-4">Assess the status of the savings accounts.</span>
      </div>
      <span class="relative z-4 right-100 bottom-0 material-symbols-outlined">
        navigate_next
      </span>
    ...
    <a
      href="/cooperative/cs_transactions"
      class="bg-buttonp rounded-lg z-4 mb-1 border-2 border-outline p-4 flex items-center hover:bg-buttonphover active:bg-buttonpactive"
    >
      <span class="text-3xl material-symbols-outlined mr-5"> contract </span>
      <div class="flex w-full flex-col h-full">
        <span>Savings Transactions</span>
        <span class="text-subtext z-4">Track all transactions of all savings accounts.</span>
      </div>
      <span class="relative z-4 right-100 bottom-0 material-symbols-outlined">
        navigate_next
      </span>
    ...
    <a
      href="/cooperative/loan_records"
      class="bg-buttonp rounded-lg z-4 border-2 mb-1 border-outline p-4 flex items-center hover:bg-buttonphover active:bg-buttonpactive"
    >
      <span class="text-3xl material-symbols-outlined mr-5"> warehouse </span>
      <div class="flex w-full flex-col h-full">
        <span>Loan Records</span>
        <span class="text-subtext z-4">Assess the status of the loan records.</span>
      </div>
      <span class="relative z-4 right-100 bottom-0 material-symbols-outlined">
        navigate_next
      </span>
    ...
    <a
      href="/cooperative/cl_transactions"
      class="bg-buttonp rounded-lg z-4 mb-1 border-2 border-outline p-4 flex items-center hover:bg-buttonphover active:bg-buttonpactive"
    >
      <span class="text-3xl material-symbols-outlined mr-5"> contract </span>
      <div class="flex w-full flex-col h-full">
        <span>Loan Transactions</span>
        <span class="text-subtext z-4">Track all transactions of all loan records.</span>
      </div>
      <span class="relative z-4 right-100 bottom-0 material-symbols-outlined">
        navigate_next
      </span>
