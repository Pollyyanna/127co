<script lang="ts">
    ...
    import { cmPayoutHeaders as headers } from "$lib/headers";
  
    export let data: NonNullable<PageServerData>;
  
    let rows = data["cmPayout"];
  ...
  <main class="w-full">
    <Breadcrumb
      items={[
        ...
        { href: "/cooperative/cm_payout", text: "Membership Payout Transactions" },
      ]}
    />
    ...
    <a
      href="/cooperative/cm_payout/add"
